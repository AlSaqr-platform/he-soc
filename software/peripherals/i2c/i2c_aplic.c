  ...
  for (u=0;u<N_I2C;u++) {
    for (int v = 0; v < N_REPS[u]; v++){
      ...
      */
      ...
      config_irq_plic(rx_i2c_plic_id);
      config_irq_plic(cmd_i2c_plic_id);
      config_irq_plic(timer_0_plic_id);
