...
int main(int argc, char const *argv[]) {
  ...
  //pulp_write32(0x1000001c, 0x3feb4e21);
  pulp_write32(0x1C0011b8, 0x1c0089d8);
  ...
  pulp_write32(0x1c00118c, 0x1c0089ee);
  pulp_write32(0x1c0011c0, 0x10000328);
