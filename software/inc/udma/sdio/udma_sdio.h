...
#define CMD2   0x2 // ALL_SEND_CID
#define CMD3   0x3 // SEND_RELATIVE_ADDR
#define ACMD6  0x6 //CFG_QUAD
#define CMD7   0x7 // CMD select
#define CMD55  0x55 // APP_SPEC_CMD
#define ACMD41 0x41 // Get voltage window--ACMD, need to be used after APP_SPEC_CMD
#define CMD8   0x8 // Send voltage
#define CMD12  0x12 // CMD_SD_STOP

#define CMD17  0x17 // READ_SINGLE_BLOCK
#define CMD18  0x18 // READ_MULTIPLE_BLOCK

#define CMD24  0x24 // WRITE_SINGLE_BLOCK
#define CMD25  0x25 // WRITE_MULTIPLE_BLOCK
*/
...
#define CMD18  0x120 // READ_MULTIPLE_BLOCK

#define CMD24  0x180 // WRITE_SINGLE_BLOCK
#define CMD25  0x190 // WRITE_MULTIPLE_BLOCK

#define CMD32  0x200 // WRITE_MULTIPLE_BLOCK
#define CMD33  0x210 // WRITE_MULTIPLE_BLOCK
#define CMD38  0x260 // WRITE_MULTIPLE_BLOCK*/
