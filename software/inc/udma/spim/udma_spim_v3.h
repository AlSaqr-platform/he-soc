...
//QSPI REGISTERS
#define UDMA_QSPIM_OFFSET(id)          UDMA_PERIPH_OFFSET(ARCHI_UDMA_QSPIM_ID(id))
#define UDMA_QSPIM_CMD_ADDR(id)        (ARCHI_UDMA_ADDR + UDMA_QSPIM_OFFSET(id) + 0x20)
#define UDMA_QSPIM_RX_ADDR(id)         (ARCHI_UDMA_ADDR + UDMA_QSPIM_OFFSET(id) + 0x00)
#define UDMA_QSPIM_TX_ADDR(id)         (ARCHI_UDMA_ADDR + UDMA_QSPIM_OFFSET(id) + 0x10)
#define UDMA_QSPIM_CUSTOM_ADDR(id)     (ARCHI_UDMA_ADDR + UDMA_QSPIM_OFFSET(id) + UDMA_CHANNEL_CUSTOM_OFFSET)
