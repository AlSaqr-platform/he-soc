...
#define ARCHI_SOC_UDMA_PERIPHERALS_ADDR    0x1A200000
...
#define ARCHI_UDMA_OFFSET             0x00000000


#define ARCHI_GPIO_ADDR              ( ARCHI_SOC_PERIPHERALS_ADDR + ARCHI_GPIO_OFFSET )
#define ARCHI_UDMA_ADDR              ( ARCHI_SOC_UDMA_PERIPHERALS_ADDR + ARCHI_UDMA_OFFSET )
