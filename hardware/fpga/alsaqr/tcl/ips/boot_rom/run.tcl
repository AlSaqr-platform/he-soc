...
set_property -dict [list CONFIG.depth {1024} CONFIG.data_width {64} CONFIG.memory_type {rom} CONFIG.input_options {registered} CONFIG.output_options {registered} ] [get_ips  xilinx_rom_bank_1024x64]
