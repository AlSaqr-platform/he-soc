...
set_property -dict [list CONFIG.C0.DDR4_Clamshell {false} CONFIG.C0.DDR4_TimePeriod {833} CONFIG.C0.DDR4_InputClockPeriod {4000} CONFIG.C0.DDR4_CLKOUT0_DIVIDE {5} CONFIG.C0.DDR4_MemoryPart {MT40A256M16GE-083E} CONFIG.C0.DDR4_DataWidth {16} CONFIG.C0.DDR4_AxiSelection {true} CONFIG.C0.DDR4_CasWriteLatency {12} CONFIG.C0.DDR4_AxiDataWidth {64} CONFIG.C0.DDR4_AxiArbitrationScheme {ROUND_ROBIN} CONFIG.C0.DDR4_AxiAddressWidth {29} CONFIG.C0.DDR4_AxiIDWidth {7} CONFIG.ADDN_UI_CLKOUT1_FREQ_HZ {18} CONFIG.System_Clock {No_Buffer} CONFIG.C0.BANK_GROUP_WIDTH {1} CONFIG.C0.CS_WIDTH {1}] [get_ips ddr4_0]
