...
set_property -dict [list CONFIG.depth {1024} CONFIG.data_width {22} CONFIG.memory_type {rom} CONFIG.input_options {registered} CONFIG.output_options {non_registered} CONFIG.single_port_output_clock_enable {false} CONFIG.default_data {00000000}] [get_ips  xilinx_rom_bank_1024x22]
