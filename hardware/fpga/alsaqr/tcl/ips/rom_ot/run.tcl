...
set_property -dict [list CONFIG.depth {8192} CONFIG.data_width {40} CONFIG.memory_type {rom} CONFIG.input_options {registered} CONFIG.output_options {non_registered} CONFIG.single_port_output_clock_enable {false} CONFIG.default_data {ffffffff}] [get_ips  xilinx_rom_bank_8192x40]
exec cp boot_code.coe xilinx_rom_bank_8192x40.srcs/sources_1/ip/boot_code.coe
set_property -dict [list CONFIG.coefficient_file {../boot_code.coe}] [get_ips xilinx_rom_bank_8192x40]
