...
#set_property -dict {PACKAGE_PIN BF10 IOSTANDARD LVCMOS18}  [get_ports FMC_hyper1_ck]
#set_property -dict {PACKAGE_PIN BF9  IOSTANDARD LVCMOS18}  [get_ports FMC_hyper1_ckn]
#set_property -dict {PACKAGE_PIN AY8  IOSTANDARD LVCMOS18}  [get_ports FMC_hyper1_rwds]
