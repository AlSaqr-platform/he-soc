...
set_property -dict {PACKAGE_PIN AP12 IOSTANDARD LVCMOS18}  [get_ports FMC_hyper0_ck]
set_property -dict {PACKAGE_PIN AR12 IOSTANDARD LVCMOS18}  [get_ports FMC_hyper0_ckn]
...
set_property -dict {PACKAGE_PIN BD13 IOSTANDARD LVCMOS18}  [get_ports FMC_hyper0_dqio4]
set_property -dict {PACKAGE_PIN BE13 IOSTANDARD LVCMOS18}  [get_ports FMC_hyper0_dqio5]
...
set_property -dict {PACKAGE_PIN AT14 IOSTANDARD LVCMOS18}  [get_ports FMC_hyper0_csn1]
...
set_property -dict {PACKAGE_PIN AW13 IOSTANDARD LVCMOS18}  [get_ports FMC_hyper1_csn1]
set_property -dict {PACKAGE_PIN AY13 IOSTANDARD LVCMOS18}  [get_ports FMC_hyper1_csn0]
set_property -dict {PACKAGE_PIN AT12 IOSTANDARD LVCMOS18}  [get_ports FMC_hyper1_reset]
...
set_property -dict { PACKAGE_PIN BF10 IOSTANDARD LVDS } [ get_ports "pad_periphs_pad_gpio_b_00_pad"]
set_property -dict { PACKAGE_PIN AN16 IOSTANDARD LVDS } [ get_ports "pad_periphs_pad_gpio_b_01_pad"]
set_property -dict { PACKAGE_PIN AY8  IOSTANDARD LVDS } [ get_ports "pad_periphs_pad_gpio_b_02_pad"]
set_property -dict { PACKAGE_PIN BF9  IOSTANDARD LVDS } [ get_ports "pad_periphs_pad_gpio_b_03_pad"]

set_property -dict { PACKAGE_PIN AK15 IOSTANDARD LVDS } [ get_ports "pad_periphs_pad_gpio_b_04_pad"]
set_property -dict { PACKAGE_PIN AL15 IOSTANDARD LVDS } [ get_ports "pad_periphs_pad_gpio_b_05_pad"]

set_property -dict { PACKAGE_PIN AW8  IOSTANDARD LVDS } [ get_ports "pad_periphs_pad_gpio_b_06_pad"]
set_property -dict { PACKAGE_PIN AM14 IOSTANDARD LVDS } [ get_ports "pad_periphs_pad_gpio_b_07_pad"]

set_property -dict { PACKAGE_PIN AU11 IOSTANDARD LVDS } [ get_ports "pad_periphs_pad_gpio_b_08_pad"]
set_property -dict { PACKAGE_PIN AV11 IOSTANDARD LVDS } [ get_ports "pad_periphs_pad_gpio_b_09_pad"]
set_property -dict { PACKAGE_PIN AP15 IOSTANDARD LVDS } [ get_ports "pad_periphs_pad_gpio_b_10_pad"]
set_property -dict { PACKAGE_PIN AU12 IOSTANDARD LVDS } [ get_ports "pad_periphs_pad_gpio_b_11_pad"]
set_property -dict { PACKAGE_PIN BC13 IOSTANDARD LVDS } [ get_ports "pad_periphs_pad_gpio_b_12_pad"]
set_property -dict { PACKAGE_PIN AN15 IOSTANDARD LVDS } [ get_ports "pad_periphs_pad_gpio_b_13_pad"]
