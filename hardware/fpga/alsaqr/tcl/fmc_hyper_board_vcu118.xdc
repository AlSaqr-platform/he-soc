...
set_property PACKAGE_PIN BF10 [ get_ports "pad_periphs_pad_gpio_b_00_pad"]
set_property PACKAGE_PIN AN16 [ get_ports "pad_periphs_pad_gpio_b_01_pad"]
set_property PACKAGE_PIN AY8 [ get_ports "pad_periphs_pad_gpio_b_02_pad"]
set_property PACKAGE_PIN BF9 [ get_ports "pad_periphs_pad_gpio_b_03_pad"]
...
set_property PACKAGE_PIN AW8 [ get_ports "pad_periphs_pad_gpio_b_06_pad"]
set_property PACKAGE_PIN AM14 [ get_ports "pad_periphs_pad_gpio_b_07_pad"]
...
set_property PACKAGE_PIN AP15 [ get_ports "pad_periphs_pad_gpio_b_10_pad"]
set_property PACKAGE_PIN AU12 [ get_ports "pad_periphs_pad_gpio_b_11_pad"]
set_property PACKAGE_PIN BC13 [ get_ports "pad_periphs_pad_gpio_b_12_pad"]
set_property PACKAGE_PIN AN15 [ get_ports "pad_periphs_pad_gpio_b_13_pad"]