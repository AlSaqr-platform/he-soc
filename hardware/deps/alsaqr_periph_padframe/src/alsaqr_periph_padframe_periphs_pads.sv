...
=======
   ...
   pad_alsaqr i_pad_gpio_f_26 (
    .OEN(mux_to_pads_i.pad_gpio_f_26.oen),
    .I(mux_to_pads_i.pad_gpio_f_26.chip2pad),
    .O(pads_to_mux_o.pad_gpio_f_26.pad2chip),
    .PUEN(mux_to_pads_i.pad_gpio_f_26.puen),
    .PAD(pad_pad_gpio_f_26_pad),
    .DRV(mux_to_pads_i.pad_gpio_f_26.drv),
    .SLW(mux_to_pads_i.pad_gpio_f_26.slw),
    .SMT(mux_to_pads_i.pad_gpio_f_26.smt),
    .PWROK(PWROK_S),
    .IOPWROK(IOPWROK_S),
    .BIAS(BIAS_S),
    .RETC(RETC_S)
  );
   pad_alsaqr i_pad_gpio_f_27 (
    .OEN(mux_to_pads_i.pad_gpio_f_27.oen),
    .I(mux_to_pads_i.pad_gpio_f_27.chip2pad),
    .O(pads_to_mux_o.pad_gpio_f_27.pad2chip),
    .PUEN(mux_to_pads_i.pad_gpio_f_27.puen),
    .PAD(pad_pad_gpio_f_27_pad),
    .DRV(mux_to_pads_i.pad_gpio_f_27.drv),
    .SLW(mux_to_pads_i.pad_gpio_f_27.slw),
    .SMT(mux_to_pads_i.pad_gpio_f_27.smt),
    .PWROK(PWROK_S),
    .IOPWROK(IOPWROK_S),
    .BIAS(BIAS_S),
    .RETC(RETC_S)
  );
   pad_alsaqr i_pad_gpio_f_28 (
    .OEN(mux_to_pads_i.pad_gpio_f_28.oen),
    .I(mux_to_pads_i.pad_gpio_f_28.chip2pad),
    .O(pads_to_mux_o.pad_gpio_f_28.pad2chip),
    .PUEN(mux_to_pads_i.pad_gpio_f_28.puen),
    .PAD(pad_pad_gpio_f_28_pad),
    .DRV(mux_to_pads_i.pad_gpio_f_28.drv),
    .SLW(mux_to_pads_i.pad_gpio_f_28.slw),
    .SMT(mux_to_pads_i.pad_gpio_f_28.smt),
    .PWROK(PWROK_S),
    .IOPWROK(IOPWROK_S),
    .BIAS(BIAS_S),
    .RETC(RETC_S)
