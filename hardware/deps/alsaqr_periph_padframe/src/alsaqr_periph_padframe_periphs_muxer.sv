...
#(
  ...
  alsaqr_periph_padframe_periphs_config_reg_top #(
   ...
   always_comb begin
     unique case (s_reg2hw.pad_gpio_b_58_mux_sel.q)
       PAD_MUX_GROUP_PAD_GPIO_B_58_SEL_DEFAULT: begin
         ...
         mux_to_pads_o.pad_gpio_b_58.puen = s_reg2hw.pad_gpio_b_58_cfg.puen.q;
       end
       PAD_MUX_GROUP_PAD_GPIO_B_58_SEL_GPIO_B_GPIO58: begin
          mux_to_pads_o.pad_gpio_b_58.chip2pad = port_signals_soc2pad_i.gpio_b.gpio58_i;
          mux_to_pads_o.pad_gpio_b_58.oen = ~port_signals_soc2pad_i.gpio_b.gpio58_d_i;
          mux_to_pads_o.pad_gpio_b_58.puen = 1'b1;
       end
       default: begin
         mux_to_pads_o.pad_gpio_b_58.chip2pad = s_reg2hw.pad_gpio_b_58_cfg.chip2pad.q;
         mux_to_pads_o.pad_gpio_b_58.oen = s_reg2hw.pad_gpio_b_58_cfg.oen.q;
   ...
   always_comb begin
     unique case (s_reg2hw.pad_gpio_b_59_mux_sel.q)
       PAD_MUX_GROUP_PAD_GPIO_B_59_SEL_DEFAULT: begin
         ...
         mux_to_pads_o.pad_gpio_b_59.puen = s_reg2hw.pad_gpio_b_59_cfg.puen.q;
       end
       PAD_MUX_GROUP_PAD_GPIO_B_59_SEL_GPIO_B_GPIO59: begin
          mux_to_pads_o.pad_gpio_b_59.chip2pad = port_signals_soc2pad_i.gpio_b.gpio59_i;
          mux_to_pads_o.pad_gpio_b_59.oen = ~port_signals_soc2pad_i.gpio_b.gpio59_d_i;
          mux_to_pads_o.pad_gpio_b_59.puen = 1'b1;
       end
       default: begin
         mux_to_pads_o.pad_gpio_b_59.chip2pad = s_reg2hw.pad_gpio_b_59_cfg.chip2pad.q;
         mux_to_pads_o.pad_gpio_b_59.oen = s_reg2hw.pad_gpio_b_59_cfg.oen.q;
   ...
   always_comb begin
     unique case (s_reg2hw.pad_gpio_b_60_mux_sel.q)
       PAD_MUX_GROUP_PAD_GPIO_B_60_SEL_DEFAULT: begin
         ...
         mux_to_pads_o.pad_gpio_b_60.puen = s_reg2hw.pad_gpio_b_60_cfg.puen.q;
       end
       PAD_MUX_GROUP_PAD_GPIO_B_60_SEL_GPIO_B_GPIO60: begin
          mux_to_pads_o.pad_gpio_b_60.chip2pad = port_signals_soc2pad_i.gpio_b.gpio60_i;
          mux_to_pads_o.pad_gpio_b_60.oen = ~port_signals_soc2pad_i.gpio_b.gpio60_d_i;
          mux_to_pads_o.pad_gpio_b_60.puen = 1'b1;
       end
       default: begin
         mux_to_pads_o.pad_gpio_b_60.chip2pad = s_reg2hw.pad_gpio_b_60_cfg.chip2pad.q;
         mux_to_pads_o.pad_gpio_b_60.oen = s_reg2hw.pad_gpio_b_60_cfg.oen.q;
   ...
   always_comb begin
     unique case (s_reg2hw.pad_gpio_b_61_mux_sel.q)
       PAD_MUX_GROUP_PAD_GPIO_B_61_SEL_DEFAULT: begin
         ...
         mux_to_pads_o.pad_gpio_b_61.puen = s_reg2hw.pad_gpio_b_61_cfg.puen.q;
       end
       PAD_MUX_GROUP_PAD_GPIO_B_61_SEL_GPIO_B_GPIO61: begin
          mux_to_pads_o.pad_gpio_b_61.chip2pad = port_signals_soc2pad_i.gpio_b.gpio61_i;
          mux_to_pads_o.pad_gpio_b_61.oen = ~port_signals_soc2pad_i.gpio_b.gpio61_d_i;
          mux_to_pads_o.pad_gpio_b_61.puen = 1'b1;
       end
       default: begin
         mux_to_pads_o.pad_gpio_b_61.chip2pad = s_reg2hw.pad_gpio_b_61_cfg.chip2pad.q;
         mux_to_pads_o.pad_gpio_b_61.oen = s_reg2hw.pad_gpio_b_61_cfg.oen.q;
   ...
   always_comb begin
     unique case (s_reg2hw.pad_gpio_f_13_mux_sel.q)
       ...
       PAD_MUX_GROUP_PAD_GPIO_F_13_SEL_UART6_UART_TX: begin
          mux_to_pads_o.pad_gpio_f_13.chip2pad = port_signals_soc2pad_i.uart6.tx_i;
  ...
  logic [PORT_MUX_GROUP_PAD_GPIO_B_58_SEL_WIDTH-1:0] port_mux_sel_gpio_b_gpio58_o_arbitrated;
  logic port_mux_sel_gpio_b_gpio58_o_no_connection;

   assign port_mux_sel_gpio_b_gpio58_o_req[PORT_MUX_GROUP_PAD_GPIO_B_58_SEL_PAD_GPIO_B_58] = s_reg2hw.pad_gpio_b_58_mux_sel.q == PAD_MUX_GROUP_PAD_GPIO_B_58_SEL_GPIO_B_GPIO58 ? 1'b1 : 1'b0;
     ...
     if (port_mux_sel_gpio_b_gpio58_o_no_connection) begin
        ...
        unique case (port_mux_sel_gpio_b_gpio58_o_arbitrated)
          PORT_MUX_GROUP_PAD_GPIO_B_58_SEL_PAD_GPIO_B_58: begin
            port_signals_pad2soc_o.gpio_b.gpio58_o = pads_to_mux_i.pad_gpio_b_58.pad2chip;
          end
          default: begin
            port_signals_pad2soc_o.gpio_b.gpio58_o = 1'b0;
          end
  ...
  logic [PORT_MUX_GROUP_PAD_GPIO_B_59_SEL_WIDTH-1:0] port_mux_sel_gpio_b_gpio59_o_arbitrated;
  logic port_mux_sel_gpio_b_gpio59_o_no_connection;

   assign port_mux_sel_gpio_b_gpio59_o_req[PORT_MUX_GROUP_PAD_GPIO_B_59_SEL_PAD_GPIO_B_59] = s_reg2hw.pad_gpio_b_59_mux_sel.q == PAD_MUX_GROUP_PAD_GPIO_B_59_SEL_GPIO_B_GPIO59 ? 1'b1 : 1'b0;
     ...
     if (port_mux_sel_gpio_b_gpio59_o_no_connection) begin
        ...
        unique case (port_mux_sel_gpio_b_gpio59_o_arbitrated)
          PORT_MUX_GROUP_PAD_GPIO_B_59_SEL_PAD_GPIO_B_59: begin
            port_signals_pad2soc_o.gpio_b.gpio59_o = pads_to_mux_i.pad_gpio_b_59.pad2chip;
          end
          default: begin
            port_signals_pad2soc_o.gpio_b.gpio59_o = 1'b0;
          end
  ...
  logic [PORT_MUX_GROUP_PAD_GPIO_B_60_SEL_WIDTH-1:0] port_mux_sel_gpio_b_gpio60_o_arbitrated;
  logic port_mux_sel_gpio_b_gpio60_o_no_connection;

   assign port_mux_sel_gpio_b_gpio60_o_req[PORT_MUX_GROUP_PAD_GPIO_B_60_SEL_PAD_GPIO_B_60] = s_reg2hw.pad_gpio_b_60_mux_sel.q == PAD_MUX_GROUP_PAD_GPIO_B_60_SEL_GPIO_B_GPIO60 ? 1'b1 : 1'b0;
     ...
     if (port_mux_sel_gpio_b_gpio60_o_no_connection) begin
        ...
        unique case (port_mux_sel_gpio_b_gpio60_o_arbitrated)
          PORT_MUX_GROUP_PAD_GPIO_B_60_SEL_PAD_GPIO_B_60: begin
            port_signals_pad2soc_o.gpio_b.gpio60_o = pads_to_mux_i.pad_gpio_b_60.pad2chip;
          end
          default: begin
            port_signals_pad2soc_o.gpio_b.gpio60_o = 1'b0;
          end
  ...
  logic [PORT_MUX_GROUP_PAD_GPIO_B_61_SEL_WIDTH-1:0] port_mux_sel_gpio_b_gpio61_o_arbitrated;
  logic port_mux_sel_gpio_b_gpio61_o_no_connection;

   assign port_mux_sel_gpio_b_gpio61_o_req[PORT_MUX_GROUP_PAD_GPIO_B_61_SEL_PAD_GPIO_B_61] = s_reg2hw.pad_gpio_b_61_mux_sel.q == PAD_MUX_GROUP_PAD_GPIO_B_61_SEL_GPIO_B_GPIO61 ? 1'b1 : 1'b0;
     ...
     if (port_mux_sel_gpio_b_gpio61_o_no_connection) begin
        ...
        unique case (port_mux_sel_gpio_b_gpio61_o_arbitrated)
          PORT_MUX_GROUP_PAD_GPIO_B_61_SEL_PAD_GPIO_B_61: begin
            port_signals_pad2soc_o.gpio_b.gpio61_o = pads_to_mux_i.pad_gpio_b_61.pad2chip;
          end
          default: begin
            port_signals_pad2soc_o.gpio_b.gpio61_o = 1'b0;
          end
  ...
  logic [PORT_MUX_GROUP_PAD_GPIO_F_14_SEL_WIDTH-1:0] port_mux_sel_uart6_rx_o_arbitrated;
  logic port_mux_sel_uart6_rx_o_no_connection;

   assign port_mux_sel_uart6_rx_o_req[PORT_MUX_GROUP_PAD_GPIO_F_14_SEL_PAD_GPIO_F_14] = s_reg2hw.pad_gpio_f_14_mux_sel.q == PAD_MUX_GROUP_PAD_GPIO_F_14_SEL_UART6_UART_RX ? 1'b1 : 1'b0;
     ...
     if (port_mux_sel_uart6_rx_o_no_connection) begin
        ...
        unique case (port_mux_sel_uart6_rx_o_arbitrated)
          PORT_MUX_GROUP_PAD_GPIO_F_14_SEL_PAD_GPIO_F_14: begin
            port_signals_pad2soc_o.uart6.rx_o = pads_to_mux_i.pad_gpio_f_14.pad2chip;
          end
          default: begin
            port_signals_pad2soc_o.uart6.rx_o = 1'b1;
          end
