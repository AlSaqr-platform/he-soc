...
We now support the software environment on a real platform which includes Shaheen SoC and its Printed Circuit Board (PCB).
The documentation of the PCB can be found here: https://github.com/AlSaqr-platform/Shaheen_PCB

Requirements:

* RISC-V Toolchain: https://github.com/riscv-collab/riscv-gnu-toolchain

* Open OCD (11) RISC-V: https://github.com/riscv/riscv-openocd

* GDB: https://github.com/riscvarchive/riscv-binutils-gdb

NB: Verify your RISCV_PREFIX define in `software/common.mk` line 19

Open OCD with:

```
/your-path/riscv-openocd/src/openocd -f  /your-path/he-soc/ocd_cfg/gen-cfg.cfg
...
```
riscv64-unknown-linux-gnu-gdb testname.riscv
