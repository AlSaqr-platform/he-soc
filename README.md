...
### The hacker way to run Alsaqr and OpenPiton
This is just a quick way as a group of commands to run tests on a cluster generated by OpenPiton and connected to Alsaqr. It is still most recommended to read Alsaqr and OpenPiton readme first to setup your env and stay away of unexpected errors.
...
>>>>>>> update readme with one section to as hacker way to run hello cva6 on a cluster generated by openpiton and connected to alsaqr
